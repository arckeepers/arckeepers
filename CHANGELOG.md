...
- **Update Projects** - Add Trophy Display and remove Flickering Flames projects

## [1.1.0] - 2026-01-12

- **Data Versions** - Support versioned local data to facilitate migrations
- **Add Expedition 1** - It's apparent that some raiders are still completing Expedition 1
- **IU sorting** - Add missing alphabetic sorting in keeplists and demands
